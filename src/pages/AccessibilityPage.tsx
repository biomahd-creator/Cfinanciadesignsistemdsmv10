                      ...
                      <div className="bg-muted/50 p-3 rounded-lg">
                        <p className="text-sm">
                          ...
                          {lightLevel.pass && darkLevel.pass ? (
                            ...
                            <span className="text-red-600">❌ No usar (o cambiar tono).</span>
                          )}
                        </p>
                      </div>
                    </div>
        ...
        <TabsContent value="testing" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Cómo validar la accesibilidad de tus componentes
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">Navegación por Teclado</h4>
                      <p className="text-sm text-muted-foreground">Manual Testing</p>
                    </div>
                  </div>
                  <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1 ml-2">
                    <li>Usa <code>Tab</code> para navegar entre elementos interactivos</li>
                    <li>Verifica que el foco sea visible (anillo verde)</li>
                    <li>Usa <code>Enter</code> y <code>Space</code> para activar</li>
                    <li>Usa <code>Esc</code> para cerrar modales</li>
                  </ul>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Assistive Tech</p>
                    </div>
                  </div>
                  <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1 ml-2">
                    <li>Verifica etiquetas <code>aria-label</code></li>
                    <li>Comprueba roles semánticos (button, navigation)</li>
                    <li>Asegura que el orden de lectura sea lógico</li>
                    <li>Prueba con NVDA (Windows) o VoiceOver (Mac)</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-muted p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">Imágenes con texto alternativo (alt)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500" />
                    <span className="text-sm">Estructura de encabezados lógica (h1-h6)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500" />
                    <span className="text-sm">Formularios con etiquetas (labels)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500" />
                    <span className="text-sm">Contraste suficiente en texto</span>
                  </div>
                </div>
              </div>
            </CardContent>
