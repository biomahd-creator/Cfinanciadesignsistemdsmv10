...
import { Check, User, Briefcase, FileText, Mail, ChevronRight } from "lucide-react";
...
// Demo Component - El stepper funcional con todo el contenido
...
export function MultiStepForm() {
  ...
  const usageCode = `import { MultiStepForm } from "@/components/patterns/multi-step-form";
    ...
    <div className="w-full space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Formulario multi-paso con indicador de progreso vertical a la izquierda. Perfecto para procesos 
          de registro, configuración o solicitudes que requieren múltiples pasos de información.
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Este patrón sigue el estándar de UX para formularios multi-paso con stepper vertical:
            progreso visible a la izquierda, contenido del formulario a la derecha, y navegación clara
            entre pasos. Ideal para formularios complejos que necesitan ser divididos en secciones lógicas.
          </p>
