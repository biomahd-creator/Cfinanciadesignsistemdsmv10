...
export function OperationDetailStep1({ onBack, onContinue }: OperationDetailStep1Props) {
  ...
  return (
    <div className="space-y-8 p-6 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <Card className="bg-[#f7fccb] border-none shadow-sm">
      ...
      <div className="fixed bottom-0 right-0 w-full bg-gradient-to-t from-white via-white/90 to-transparent pb-8 pt-12 px-8 flex justify-end pointer-events-none">
        <Button 
