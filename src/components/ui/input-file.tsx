    ...
    return (
      <div className="space-y-4">
        <div
          ...
          className={cn(
            "border-input hover:border-ring flex flex-col items-center justify-center gap-2 rounded-md border-2 border-dashed bg-muted/20 p-8 text-center transition-colors",
            className
          )}
        >
        ...
        {showPreview && files.length > 0 && (
          <div className="space-y-2">
            {files.map((file, index) => (
              <div
                key={index}
                className="bg-muted/50 border-border flex items-center gap-3 rounded-md border p-3"
              >
