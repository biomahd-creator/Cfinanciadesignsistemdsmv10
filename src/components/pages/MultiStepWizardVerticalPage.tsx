...
export function MultiStepWizardVerticalPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-4xl font-semibold mb-2">Multi-Step Wizard (Vertical)</h2>
        <p className="text-muted-foreground">
          Wizard avanzado con validación de pasos y stepper vertical a un lado
        </p>
      </div>

      <div className="grid md:grid-cols-[320px,1fr] gap-6">
        {/* Vertical Stepper - Enhanced Sidebar */}
                  ...
                  <div key={step.id} className="relative">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isActive && "bg-primary/10 border-2 border-secondary shadow-sm",
                    ...
                    >
                      ...
                      <div
                        className={cn(
                          ...
                          isActive && !isCompleted && "bg-primary/20 text-secondary ring-2 ring-primary/30",
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <Badge variant="secondary">{wizardData.sectorEmpresa}</Badge>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Tamaño:</span>
                        <Badge variant="secondary">{wizardData.tamanoEmpresa}</Badge>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{wizardData.plazoPromedio} días</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Tipo:</span>
                        <Badge>{wizardData.tipoFactoring}</Badge>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Método de Pago:</span>
                        <span className="font-medium">{wizardData.metodoPago}</span>
                      </div>
                    </div>
                  </div>
                </div>
