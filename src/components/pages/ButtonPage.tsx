  ...
  return (
    <div className="flex gap-4">
      ...
      <Button variant="outline" asChild>
        ...
        {
          title: "Pill Buttons",
          description: "Botones completamente redondeados usando className rounded-full",
          preview: (
            <div className="flex flex-col gap-4">
              <div className="flex flex-wrap items-center gap-4">
                <Button className="rounded-full">Default Pill</Button>
                <Button variant="secondary" className="rounded-full">Secondary Pill</Button>
                <Button variant="outline" className="rounded-full">Outline Pill</Button>
                <Button variant="ghost" className="rounded-full">Ghost Pill</Button>
              </div>
              <div className="flex flex-wrap gap-4">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Button size="sm" className="rounded-full">Small Pill</Button>
                <Button className="rounded-full">Default Pill</Button>
                <Button size="lg" className="rounded-full">Large Pill</Button>
              </div>
            </div>
          ),
          code: `import { Button } from "@/components/ui/button";
