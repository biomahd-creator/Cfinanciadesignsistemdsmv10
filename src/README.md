...
| **/components/factoring/FACTORING_ARCHITECTURE.md** | Arquitectura del módulo Factoring | ✅ Completo |
...
| **Factoring App** | [`/components/factoring/FACTORING_ARCHITECTURE.md`](/components/factoring/FACTORING_ARCHITECTURE.md) | Antes de modificar el módulo de Factoring |
...
| Módulo | README Rápido |
|--------|---------------|
| **Factoring App** | [`/components/factoring/README.md`](/components/factoring/README.md) |
...
│   │   └── StatusKPICard.tsx
│   │
│   ├── /factoring/                  # Business Module: Factoring App
│   │   ├── FactoringApp.tsx
│   │   ├── FACTORING_ARCHITECTURE.md
│   │   ├── README.md
│   │   └── /views/
│   │
...
| **Business Modules** | 11 | `/components/factoring/`, `/components/atomic/pages/` |
...
2. **[FACTORING_ARCHITECTURE.md](/components/factoring/FACTORING_ARCHITECTURE.md)** - Módulo de Factoring
   - 7 vistas documentadas
   - Flujos de navegación internos
   - Roles y autenticación
   - Mapa completo de componentes

3. **[ATOMIC_DESIGN_ARCHITECTURE.md](/components/atomic/ATOMIC_DESIGN_ARCHITECTURE.md)** - Sistema Atomic Design
   - 5 niveles jerárquicos
   - 23 componentes documentados
   - Metodología Brad Frost
   - Reglas de composición

4. **[BUSINESS_COMPONENTS_ARCHITECTURE.md](/components/business/BUSINESS_COMPONENTS_ARCHITECTURE.md)** - Business Components
...
**Ver más:** [`/components/factoring/FACTORING_ARCHITECTURE.md`](/components/factoring/FACTORING_ARCHITECTURE.md) (ejemplo de restauración)
...
- [Factoring Architecture](/components/factoring/FACTORING_ARCHITECTURE.md) - Módulo Factoring
...
### Guías Rápidas:
- [Factoring README](/components/factoring/README.md) - Guía rápida Factoring
...
👉 O usa [`/components/factoring/README.md`](/components/factoring/README.md) para una guía rápida del Factoring App.
